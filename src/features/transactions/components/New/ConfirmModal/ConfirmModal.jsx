...
class ConfirmModal extends Component {
  ...
  render() {
    ...
    const  Total = (assetAlias.value ==='EY' ||assetId.value === eyID)?
      (totalAmount + fee): totalAmount

    let submitLabel = t('transaction.new.submit')

    const normalize = (value, asset) => {
      if (asset === eyID || asset === 'EY'){
        return normalizeEYAmountUnit(eyID, value, eyAmountUnit)
        ...
        <table className={styles.table}>
          <tbody>
            ...
            <tr>
              ...
              <td> <code>{normalizeEYAmountUnit(eyID, fee, eyAmountUnit)}</code> </td>
            </tr>
