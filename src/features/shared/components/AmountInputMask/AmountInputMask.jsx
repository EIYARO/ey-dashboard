...
import { parseEYAmount, formatEYAmount, addZeroToDecimalPosition } from 'utility/buildInOutDisplay'
  ...
  componentDidMount() {
    if(this.props.fieldProps.value){
      ...
      this.props.fieldProps.onChange(
        parseEYAmount(value, this.props.decimal )
      )
      ...
      <div className='form-group'>
        {this.props.title && <FieldLabel>{this.props.title}</FieldLabel>}
          <input className='form-control'
            type={'text'}
            {...fieldProps}
            value={formatEYAmount(this.state.value, this.props.decimal)}
