...
import { normalizeEYAmountUnit } from 'utility/buildInOutDisplay'
...
class GasField extends React.Component {
  ...
  render() {
    ...
    return <div className={`form-group ${styles.slider}`}>
      <span>{normalizeEYAmountUnit(eyID, ( chainGas + fieldProps.value * this.props.gas ), this.props.eyAmountUnit)}</span>
      <input
        type='range'
        min={0}
        max={3}
