...
import { converIntToDec, addZeroToDecimalPosition, formatEYAmount, parseEYAmount } from 'utility/buildInOutDisplay'
import { FieldLabel } from 'features/shared/components'
import pick from 'lodash/pick'

const EYAmountUnit = ['EY', 'mEY', 'NEU']
...
class AmountUnitField extends React.Component {
  ...
  componentDidMount() {
    if(this.props.fieldProps.value){
      this.props.fieldProps.onChange(
        parseEYAmount(this.props.fieldProps.value, this.state.pos )
      )
  ...
  handleChange(event) {
    ...
    if (this.props.fieldProps.onChange) {
      ...
      this.props.fieldProps.onChange(
        parseEYAmount(value, this.state.pos )
      )
    }
  }
      ...
      <div className='form-group'>
        ...
        <div className='input-group'>
          <input className='form-control'
            ...
            {...fieldProps}
            value={formatEYAmount(this.state.value, this.state.pos)}
