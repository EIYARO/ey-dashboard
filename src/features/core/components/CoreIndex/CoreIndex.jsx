...
class CoreIndex extends React.Component {
  constructor(props) {
    ...
    this.changeEYamount = this.changeEYamount.bind(this)
    this.consolePopup = this.consolePopup.bind(this)
  }

  componentDidMount() {
    if(window.ipcRenderer){
      window.ipcRenderer.on('eyAmountUnitState', (event, arg) => {
        this.props.uptdateEyAmountUnit(arg)
      })
    }
  }

  changeEYamount(value) {
    this.setState({ eyAmountUnit: value })
    this.props.uptdateEyAmountUnit(value)
  }
            ...
            <tr className={styles.row}>
              ...
              <td>
                <DropdownButton
                  ...
                  title={this.props.core.eyAmountUnit || this.state.eyAmountUnit}
                  onSelect={this.changeEYamount}
                >
                  <MenuItem eventKey='EY'>EY</MenuItem>
                  <MenuItem eventKey='mEY'>mEY</MenuItem>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  uptdateEyAmountUnit: (param) => dispatch(actions.core.updateEYAmountUnit(param)),
